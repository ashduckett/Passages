...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var slideOne = new Slide('Trevor Wainwrite', 'Higher Times', 'We tried to do our copywriting ourselves, but didn\'t appreciate the knowledge and skill it would take. Passages took us by the hand and with our input and direction on what we wanted to achieve, they did a perfect job. We would always recommend Passages to anybody looking for a copywriter! Thank you!', 'slider1.png');
    var slideTwo = new Slide('Ian Frankly', 'Author', 'Modern life being as busy as it is, I desparately needed a proof reader who could edit my book. Passages were a local company and they did a perfect job.', 'slider3.png');
    var slideThree = new Slide('Sarah Gibbons', 'The Socialist Paper', 'We have a publication that goes out both online and off. Passages are always there, always do a perfect job and we couldn\'t recommend them more highly.', 'slider2.png');
